#!/usr/bin/env python3
"""
Reporte Markdown para Ola3 (p. ej. síntesis de carbono).

Reutiliza el formato de ola2_status_report, pero leyendo los CSV de Ola3
generados por run_ola2_compounds (output-root de Ola3).
"""
