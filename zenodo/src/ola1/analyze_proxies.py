...
def compute_basic_proxies(run: Dict) -> Dict:
    ...
    proxies = {
        ...
        "hbar_sim_live": run.get("hbar_sim_live"),
        "hbar_inferred": run.get("hbar_inferred"),
        "hbar_status": run.get("hbar_status"),
        "omega_ref_raw": run.get("omega_ref_raw"),
        "mass_sim_raw_gev": run.get("mass_sim_raw_gev"),
        "omega_fund_method": run.get("omega_fund_method"),
        "omega_fund": run.get("omega_fund"),
        "omega_fund_conf": run.get("omega_fund_conf"),
        "omega_fund_method_fallback": run.get("omega_fund_method_fallback"),
        "harmonic_k_max": run.get("harmonic_k_max"),
        "dominant_k": run.get("dominant_k"),
        "dominant_parity": run.get("dominant_parity"),
        "sector_confidence": run.get("sector_confidence"),
        "k_tol": run.get("k_tol"),
        "k_used": run.get("k_used"),
        "selection_method": run.get("selection_method"),
        "selection_reason": run.get("selection_reason"),
        "policy_preferred_parity": run.get("policy_preferred_parity"),
        "policy_allowed_k": json.dumps(run.get("policy_allowed_k", [])),
        "policy_score_floor": run.get("policy_score_floor"),
        "policy_applied": run.get("policy_applied"),
        "peak_used_index": run.get("peak_used_index"),
        "omega_peak_used": run.get("omega_peak_used"),
        "omega_peak_dominant": run.get("omega_peak_dominant"),
        "omega_eff": run.get("omega_eff"),
        "mass_sim_used_gev": run.get("mass_sim_used_gev"),
        "fft_topN_count": run.get("fft_topN_count"),
        "fft_peak0_freq": run.get("fft_peak0_freq"),
        "fft_peak0_mag": run.get("fft_peak0_mag"),
        "fft_peak1_freq": run.get("fft_peak1_freq"),
        "fft_peak1_mag": run.get("fft_peak1_mag"),
        "fft_peaks_entropy": run.get("fft_peaks_entropy"),
        "fft_mag_ratio_01": run.get("fft_mag_ratio_01"),
    }
...
def analyze(case: str, sm_universe: Path, output: Path, results_path: Path | None = None):
    ...
    for run in runs:
        ...
        base["f_ref"] = run.get("f_ref")
        base["delta_f"] = run.get("delta_f")
        ...
        base["fft_peak_delta"] = run.get("fft_peak_delta")
