...
## Semáforo de salud
- Runs totales: 312
- Runs aceptados: 309 (99.0%)
- Alertas: ninguna

## Entropía / Caos (nuevo)
- Fuente de datos: partial_runs
- Runs con entropy_chaos: 309
- chaos_mode: dynamic=309, ensemble=0
- PE_tick_norm (mean/med/min/max): 0.700 / 0.697 / 0.301 / 0.916
...
- structure_mix_norm (mean/med): 0.033 / 0.000
- fraction_structured (mean/med): 0.038 / 0.000

## Error de masa vs SM
| Partícula | Δ_mean% | Δ_min% | Δ_max% | n |
|-----------|---------|--------|--------|---|
| delta_1232 | +37.0756% | +8.2251% | +62.3377% | 105 |
| deuteron | +1.1858% | -2.4431% | +4.7612% | 85 |
| eta_prime | +22.8615% | -8.1209% | +47.3997% | 69 |
| quark_s_const | +1.7726% | -12.1732% | +15.7184% | 2 |
| quark_ud_const | -16.9867% | -52.8524% | +16.9218% | 9 |
| tau | -0.0476% | -3.0750% | +2.7704% | 39 |

## Promedio cósmico (Ola1)
- cosmic_chaos_temp (PE avg): 0.6996
...
|-----------|----------|---------------|------------------|
| delta_1232 | 105 | 2.560 | 5.383 |
| deuteron | 85 | 0.060 | 3.659 |
| eta_prime | 69 | 0.020 | 2.251 |
| quark_s_const | 2 | 0.434 | 0.593 |
| quark_ud_const | 9 | 0.217 | 0.869 |
| tau | 39 | 0.098 | 2.697 |

## Detalle por partícula (d_total y conteos)
| Partícula | Count | d_min | d_med | d_max | Tiers | S2 states |
|-----------|-------|-------|-------|-------|-------|-----------|
| delta_1232 | 105 | 2.560 | 4.549 | 9.594 | level1:98, none:7 | latent:9, none:92, structural:4 |
| deuteron | 85 | 0.060 | 3.551 | 8.931 | level1:85 | latent:6, none:79 |
| eta_prime | 69 | 0.020 | 2.420 | 4.538 | level1:69 | latent:3, none:66 |
| quark_s_const | 2 | 0.434 | 0.593 | 0.751 | none:2 | none:2 |
| quark_ud_const | 9 | 0.217 | 0.629 | 1.716 | level2:6, none:3 | latent:2, none:7 |
| tau | 39 | 0.098 | 2.680 | 5.458 | level1:39 | latent:4, none:35 |
...
### eta_prime_block_0001 (run_id=136)
...
### delta_1232_block_0001 (run_id=108)
...
### delta_1232_block_0002 (run_id=43)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### eta_prime_block_0002 (run_id=175)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0003 (run_id=45)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### tau_block_0001 (run_id=309)
- Partícula: tau, tier: level1, s2_state: none
- match_score.d_total: 4.953
- Bandas: count=4.0, s2_band_fraction=0.0
- band_energies_gev: [1.7272727272727275, 1.9090909090909094, 2.0, 2.0909090909090913]
- F_m (base): 1.727 GeV
- M_eff (base≈F_m): 1.727
- M_corrected (F_m*(1-H_block)): 1.721 (H_block=0.004)
- sm_mass_gev: 1.777
- Δ_mass vs SM: -2.7907%
- H_block (lock_quality): 0.004
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.7323574251342302, T_ticks=200
- mean_H_lock_norm=0.003556422176416281, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.2442 / 0.0148 / 0.7699

### delta_1232_block_0004 (run_id=179)
...
### eta_prime_block_0003 (run_id=188)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### quark_ud_const_block_0001 (run_id=83)
...
### delta_1232_block_0005 (run_id=35)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0006 (run_id=260)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 4.957
- Bandas: count=3.0, s2_band_fraction=0.0
- band_energies_gev: [1.676470588235294, 1.9117647058823528, 2.0]
- F_m (base): 1.676 GeV
- M_eff (base≈F_m): 1.676
- M_corrected (F_m*(1-H_block)): 1.668 (H_block=0.005)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +36.0772%
- H_block (lock_quality): 0.005
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.6068779332191413, T_ticks=200
- mean_H_lock_norm=0.004937460403289026, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.9504 / 0.8568 / 0.9930

### deuteron_block_0005 (run_id=63)
- Partícula: deuteron, tier: level1, s2_state: none
...
### deuteron_block_0006 (run_id=305)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 4.748
- Bandas: count=2.0, s2_band_fraction=0.0
- band_energies_gev: [1.9230769230769227, 2.0]
- F_m (base): 1.923 GeV
- M_eff (base≈F_m): 1.923
- M_corrected (F_m*(1-H_block)): 1.918 (H_block=0.003)
- sm_mass_gev: 1.876
- Δ_mass vs SM: +2.5307%
- H_block (lock_quality): 0.003
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.787159278609482, T_ticks=200
- mean_H_lock_norm=0.0027255655186611528, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.1677 / 0.0120 / 0.5311

### delta_1232_block_0007 (run_id=75)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0008 (run_id=125)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### deuteron_block_0007 (run_id=257)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 0.319
- Bandas: count=7.0, s2_band_fraction=0.0
- band_energies_gev: [1.878787878787879, 1.9393939393939397, 2.0, 2.060606060606061, 2.1212121212121215, 2.181818181818182, 2.2424242424242427]
- F_m (base): 1.879 GeV
- M_eff (base≈F_m): 1.879
- M_corrected (F_m*(1-H_block)): 1.876 (H_block=0.002)
- sm_mass_gev: 1.876
- Δ_mass vs SM: +0.1694%
- H_block (lock_quality): 0.002
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.7421048356853552, T_ticks=200
- mean_H_lock_norm=0.0015703049193905119, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0008 / 0.0000 / 0.0031

### eta_prime_block_0004 (run_id=32)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0009 (run_id=109)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### quark_ud_const_block_0002 (run_id=299)
- Partícula: quark_ud_const, tier: level2, s2_state: none
- match_score.d_total: 0.217
- Bandas: count=3.0, s2_band_fraction=0.0
- band_energies_gev: [0.30833333333333335, 0.48333333333333334, 2.0]
- F_m (base): 0.308 GeV
- M_eff (base≈F_m): 0.308
- M_corrected (F_m*(1-H_block)): 0.129 (H_block=0.581)
- sm_mass_gev: 0.336
- Δ_mass vs SM: -8.2341%
- H_block (lock_quality): 0.581
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.7460223335174425, T_ticks=200
- mean_H_lock_norm=0.00659584627019513, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.9182958340544894
- fraction_structured=0.3333333333333333
- lock_S1_series (mean/min/max): 0.5665 / 0.2047 / 0.7723

### deuteron_block_0008 (run_id=211)
- Partícula: deuteron, tier: level1, s2_state: none
...
### delta_1232_block_0010 (run_id=135)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 7.680
- Bandas: count=1.0, s2_band_fraction=0.0
- band_energies_gev: [2.0]
...
### eta_prime_block_0005 (run_id=121)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### eta_prime_block_0007 (run_id=113)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### eta_prime_block_0008 (run_id=181)
- Partícula: eta_prime, tier: level1, s2_state: latent
...
### delta_1232_block_0011 (run_id=58)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0012 (run_id=222)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### quark_s_const_block_0001 (run_id=241)
...
### delta_1232_block_0013 (run_id=137)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0014 (run_id=304)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 4.188
- Bandas: count=2.0, s2_band_fraction=0.0
- band_energies_gev: [1.6, 2.0]
- F_m (base): 1.600 GeV
...
- mean_H_lock_norm=0.0007983161450725539, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0018 / 0.0000 / 0.0065

### delta_1232_block_0015 (run_id=296)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 4.607
- Bandas: count=4.0, s2_band_fraction=0.0
- band_energies_gev: [1.5272727272727276, 1.9636363636363638, 2.0, 2.036363636363637]
- F_m (base): 1.527 GeV
- M_eff (base≈F_m): 1.527
- M_corrected (F_m*(1-H_block)): 1.519 (H_block=0.005)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +23.9669%
- H_block (lock_quality): 0.005
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.7307878562130875, T_ticks=200
- mean_H_lock_norm=0.005080496664957377, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0053 / 0.0006 / 0.0333

### deuteron_block_0010 (run_id=119)
- Partícula: deuteron, tier: level1, s2_state: none
...
### eta_prime_block_0009 (run_id=194)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 0.420
- Bandas: count=4.0, s2_band_fraction=0.0
...
### delta_1232_block_0016 (run_id=295)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 7.680
- Bandas: count=1.0, s2_band_fraction=0.0
- band_energies_gev: [2.0]
- F_m (base): 2.000 GeV
- M_eff (base≈F_m): 2.000
- M_corrected (F_m*(1-H_block)): 1.987 (H_block=0.007)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +62.3377%
- H_block (lock_quality): 0.007
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.5992399215695506, T_ticks=200
- mean_H_lock_norm=0.006509248132673511, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0012 / 0.0005 / 0.0023

### deuteron_block_0011 (run_id=60)
- Partícula: deuteron, tier: level1, s2_state: latent
...
### delta_1232_block_0017 (run_id=198)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### deuteron_block_0012 (run_id=303)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 1.846
- Bandas: count=4.0, s2_band_fraction=0.0
- band_energies_gev: [1.8571428571428572, 1.9285714285714288, 2.0, 2.785714285714286]
- F_m (base): 1.857 GeV
- M_eff (base≈F_m): 1.857
- M_corrected (F_m*(1-H_block)): 1.849 (H_block=0.005)
- sm_mass_gev: 1.876
- Δ_mass vs SM: -0.9846%
- H_block (lock_quality): 0.005
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.8041424476154545, T_ticks=200
- mean_H_lock_norm=0.004622469494065175, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0381 / 0.0038 / 0.1510

### eta_prime_block_0010 (run_id=249)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 2.420
- Bandas: count=5.0, s2_band_fraction=0.0
...
### eta_prime_block_0011 (run_id=65)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### deuteron_block_0013 (run_id=254)
- Partícula: deuteron, tier: level1, s2_state: none
...
### eta_prime_block_0012 (run_id=298)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 3.753
- Bandas: count=5.0, s2_band_fraction=0.0
- band_energies_gev: [1.3333333333333333, 1.9047619047619049, 2.0, 2.0952380952380953, 2.1904761904761907]
- F_m (base): 1.333 GeV
- M_eff (base≈F_m): 1.333
- M_corrected (F_m*(1-H_block)): 1.325 (H_block=0.006)
- sm_mass_gev: 0.958
- Δ_mass vs SM: +39.2108%
- H_block (lock_quality): 0.006
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.7248024940462457, T_ticks=200
- mean_H_lock_norm=0.006320110061430115, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0012 / 0.0001 / 0.0027

### tau_block_0007 (run_id=67)
- Partícula: tau, tier: level1, s2_state: none
...
### delta_1232_block_0018 (run_id=12)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### eta_prime_block_0013 (run_id=293)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 1.849
- Bandas: count=2.0, s2_band_fraction=0.0
- band_energies_gev: [1.1428571428571428, 2.0]
- F_m (base): 1.143 GeV
- M_eff (base≈F_m): 1.143
- M_corrected (F_m*(1-H_block)): 1.139 (H_block=0.003)
- sm_mass_gev: 0.958
- Δ_mass vs SM: +19.3236%
- H_block (lock_quality): 0.003
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.8818666009654907, T_ticks=200
- mean_H_lock_norm=0.0030143151896993587, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0029 / 0.0003 / 0.0070

### delta_1232_block_0019 (run_id=209)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### deuteron_block_0014 (run_id=279)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 7.035
- Bandas: count=2.0, s2_band_fraction=0.0
- band_energies_gev: [1.9459459459459458, 1.972972972972973, 2.0, 2.3513513513513513, 2.3783783783783785, 2.4054054054054053, 2.4324324324324325]
- F_m (base): 1.946 GeV
- M_eff (base≈F_m): 1.946
- M_corrected (F_m*(1-H_block)): 1.924 (H_block=0.011)
- sm_mass_gev: 1.876
- Δ_mass vs SM: +3.7500%
- H_block (lock_quality): 0.011
- band_power_capture: 0.8074200044251354
- chaos_mode=dynamic, PE_tick_norm=0.6159514822416411, T_ticks=200
- mean_H_lock_norm=0.011188672549243875, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0147 / 0.0003 / 0.0915

### eta_prime_block_0014 (run_id=310)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 1.909
- Bandas: count=4.0, s2_band_fraction=0.0
- band_energies_gev: [1.1489361702127658, 1.9574468085106382, 2.0, 2.0425531914893615]
- F_m (base): 1.149 GeV
- M_eff (base≈F_m): 1.149
- M_corrected (F_m*(1-H_block)): 1.140 (H_block=0.007)
- sm_mass_gev: 0.958
- Δ_mass vs SM: +19.9583%
- H_block (lock_quality): 0.007
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.7068145289195978, T_ticks=200
- mean_H_lock_norm=0.007312656173751395, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0056 / 0.0004 / 0.0189

### deuteron_block_0015 (run_id=233)
- Partícula: deuteron, tier: level1, s2_state: none
...
### delta_1232_block_0020 (run_id=57)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0021 (run_id=71)
...
### eta_prime_block_0015 (run_id=132)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### eta_prime_block_0016 (run_id=173)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### eta_prime_block_0017 (run_id=290)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 2.257
- Bandas: count=3.0, s2_band_fraction=0.0
- band_energies_gev: [1.183673469387755, 1.9591836734693877, 2.0]
- F_m (base): 1.184 GeV
- M_eff (base≈F_m): 1.184
- M_corrected (F_m*(1-H_block)): 1.180 (H_block=0.003)
- sm_mass_gev: 0.958
- Δ_mass vs SM: +23.5851%
- H_block (lock_quality): 0.003
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.7893310436717775, T_ticks=200
- mean_H_lock_norm=0.0025996833093206097, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.4451 / 0.0781 / 0.8651

### deuteron_block_0016 (run_id=286)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 0.463
- Bandas: count=7.0, s2_band_fraction=0.0
- band_energies_gev: [1.8709677419354842, 1.9354838709677422, 2.0, 2.774193548387097, 2.838709677419355, 2.9032258064516134, 2.9677419354838714]
- F_m (base): 1.871 GeV
- M_eff (base≈F_m): 1.871
- M_corrected (F_m*(1-H_block)): 1.864 (H_block=0.004)
- sm_mass_gev: 1.876
- Δ_mass vs SM: -0.2475%
- H_block (lock_quality): 0.004
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.6792449647907475, T_ticks=200
- mean_H_lock_norm=0.00377756392796257, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0022 / 0.0001 / 0.0060

### delta_1232_block_0022 (run_id=81)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### eta_prime_block_0018 (run_id=110)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### deuteron_block_0017 (run_id=285)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 1.353
- Bandas: count=3.0, s2_band_fraction=0.0
- band_energies_gev: [1.8620689655172413, 1.9310344827586208, 2.0]
- F_m (base): 1.862 GeV
- M_eff (base≈F_m): 1.862
- M_corrected (F_m*(1-H_block)): 1.851 (H_block=0.006)
- sm_mass_gev: 1.876
- Δ_mass vs SM: -0.7220%
- H_block (lock_quality): 0.006
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.6398910324492338, T_ticks=200
- mean_H_lock_norm=0.005884339209730779, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0019 / 0.0007 / 0.0047

### deuteron_block_0018 (run_id=206)
- Partícula: deuteron, tier: level1, s2_state: none
...
### delta_1232_block_0023 (run_id=308)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 3.946
- Bandas: count=3.0, s2_band_fraction=0.0
- band_energies_gev: [1.5666666666666667, 1.9, 2.0]
- F_m (base): 1.567 GeV
- M_eff (base≈F_m): 1.567
- M_corrected (F_m*(1-H_block)): 1.552 (H_block=0.010)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +27.1645%
- H_block (lock_quality): 0.010
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.5996027131312611, T_ticks=200
- mean_H_lock_norm=0.009451110723590277, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0029 / 0.0004 / 0.0072

### delta_1232_block_0024 (run_id=297)
- Partícula: delta_1232, tier: level1, s2_state: latent
- match_score.d_total: 5.161
- Bandas: count=5.0, s2_band_fraction=0.0
- band_energies_gev: [1.6875000000000002, 1.9375000000000004, 2.0, 2.0625, 2.1250000000000004]
- F_m (base): 1.688 GeV
- M_eff (base≈F_m): 1.688
- M_corrected (F_m*(1-H_block)): 1.667 (H_block=0.012)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +36.9724%
- H_block (lock_quality): 0.012
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.6100237680958429, T_ticks=200
- mean_H_lock_norm=0.012049002607790769, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0024 / 0.0005 / 0.0063

### delta_1232_block_0025 (run_id=204)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### deuteron_block_0019 (run_id=205)
- Partícula: deuteron, tier: level1, s2_state: none
...
### eta_prime_block_0019 (run_id=33)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### deuteron_block_0020 (run_id=139)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 4.440
- Bandas: count=2.0, s2_band_fraction=0.0
- band_energies_gev: [1.9200000000000002, 2.0]
...
### delta_1232_block_0026 (run_id=80)
- Partícula: delta_1232, tier: level1, s2_state: latent
...
### deuteron_block_0021 (run_id=216)
- Partícula: deuteron, tier: level1, s2_state: none
...
### delta_1232_block_0027 (run_id=26)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### eta_prime_block_0020 (run_id=223)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0028 (run_id=239)
- Partícula: delta_1232, tier: none, s2_state: structural
...
### eta_prime_block_0021 (run_id=180)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 3.753
- Bandas: count=5.0, s2_band_fraction=0.0
...
### eta_prime_block_0022 (run_id=97)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0029 (run_id=30)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### eta_prime_block_0023 (run_id=114)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 0.420
- Bandas: count=3.0, s2_band_fraction=0.0
...
### delta_1232_block_0030 (run_id=90)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### deuteron_block_0023 (run_id=218)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 3.560
- Bandas: count=2.0, s2_band_fraction=0.0
...
### deuteron_block_0024 (run_id=150)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 7.312
- Bandas: count=1.0, s2_band_fraction=0.0
...
### eta_prime_block_0024 (run_id=190)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0031 (run_id=263)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 5.195
- Bandas: count=4.0, s2_band_fraction=0.0
- band_energies_gev: [1.7021276595744679, 1.9148936170212763, 1.9999999999999998, 2.042553191489362]
- F_m (base): 1.702 GeV
- M_eff (base≈F_m): 1.702
- M_corrected (F_m*(1-H_block)): 1.695 (H_block=0.004)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +38.1597%
- H_block (lock_quality): 0.004
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.6464220300144684, T_ticks=200
- mean_H_lock_norm=0.004143314653054967, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0009 / 0.0002 / 0.0021

### eta_prime_block_0025 (run_id=5)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0032 (run_id=271)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 4.484
- Bandas: count=3.0, s2_band_fraction=0.0
- band_energies_gev: [1.4594594594594592, 1.9459459459459458, 2.0]
- F_m (base): 1.459 GeV
- M_eff (base≈F_m): 1.459
- M_corrected (F_m*(1-H_block)): 1.455 (H_block=0.003)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +18.4626%
- H_block (lock_quality): 0.003
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.8713893728236936, T_ticks=200
- mean_H_lock_norm=0.002841031858520575, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0034 / 0.0000 / 0.0223

### eta_prime_block_0026 (run_id=68)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### deuteron_block_0025 (run_id=169)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 0.463
- Bandas: count=4.0, s2_band_fraction=0.0
...
### deuteron_block_0026 (run_id=242)
- Partícula: deuteron, tier: level1, s2_state: none
...
### eta_prime_block_0027 (run_id=264)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 4.005
- Bandas: count=2.0, s2_band_fraction=0.0
- band_energies_gev: [1.3584905660377355, 2.0]
- F_m (base): 1.358 GeV
- M_eff (base≈F_m): 1.358
- M_corrected (F_m*(1-H_block)): 1.347 (H_block=0.008)
- sm_mass_gev: 0.958
- Δ_mass vs SM: +41.8374%
- H_block (lock_quality): 0.008
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.5849050660836855, T_ticks=200
- mean_H_lock_norm=0.008065742923172442, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0057 / 0.0005 / 0.0162

### eta_prime_block_0028 (run_id=17)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0033 (run_id=226)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 7.680
- Bandas: count=1.0, s2_band_fraction=0.0
- band_energies_gev: [2.0]
...
### delta_1232_block_0034 (run_id=187)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0035 (run_id=182)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### tau_block_0014 (run_id=258)
- Partícula: tau, tier: level1, s2_state: none
- match_score.d_total: 1.209
- Bandas: count=4.0, s2_band_fraction=0.0
- band_energies_gev: [1.7647058823529411, 1.8823529411764703, 2.0, 2.1176470588235294]
- F_m (base): 1.765 GeV
- M_eff (base≈F_m): 1.765
- M_corrected (F_m*(1-H_block)): 1.761 (H_block=0.002)
- sm_mass_gev: 1.777
- Δ_mass vs SM: -0.6840%
- H_block (lock_quality): 0.002
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.5820695554261802, T_ticks=200
- mean_H_lock_norm=0.0018253688369077791, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0018 / 0.0004 / 0.0034

### deuteron_block_0028 (run_id=8)
- Partícula: deuteron, tier: level1, s2_state: none
...
### eta_prime_block_0029 (run_id=251)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 0.420
- Bandas: count=3.0, s2_band_fraction=0.0
...
### delta_1232_block_0036 (run_id=259)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 3.290
- Bandas: count=6.0, s2_band_fraction=0.0
- band_energies_gev: [1.583333333333333, 1.6666666666666663, 2.0, 2.083333333333333, 2.166666666666666, 2.2499999999999996]
- F_m (base): 1.583 GeV
- M_eff (base≈F_m): 1.583
- M_corrected (F_m*(1-H_block)): 1.577 (H_block=0.004)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +28.5173%
- H_block (lock_quality): 0.004
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.7598484365077386, T_ticks=200
- mean_H_lock_norm=0.0037725646619910197, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0018 / 0.0003 / 0.0048

### eta_prime_block_0030 (run_id=104)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### deuteron_block_0029 (run_id=163)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 1.353
- Bandas: count=5.0, s2_band_fraction=0.0
...
### deuteron_block_0030 (run_id=192)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 0.893
- Bandas: count=4.0, s2_band_fraction=0.0
...
### delta_1232_block_0037 (run_id=261)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 3.845
- Bandas: count=4.0, s2_band_fraction=0.0
- band_energies_gev: [1.6470588235294117, 1.7058823529411764, 1.9999999999999998, 2.058823529411765]
- F_m (base): 1.647 GeV
- M_eff (base≈F_m): 1.647
...
- mean_H_lock_norm=0.0024887733645020294, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0015 / 0.0001 / 0.0074

### delta_1232_block_0038 (run_id=78)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0039 (run_id=127)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### deuteron_block_0031 (run_id=232)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 1.846
- Bandas: count=4.0, s2_band_fraction=0.0
...
### delta_1232_block_0040 (run_id=236)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### deuteron_block_0032 (run_id=186)
- Partícula: deuteron, tier: level1, s2_state: none
...
### delta_1232_block_0041 (run_id=46)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0042 (run_id=311)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 7.680
- Bandas: count=1.0, s2_band_fraction=0.0
- band_energies_gev: [2.0]
...
- mean_H_lock_norm=0.0051680477007557185, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0006 / 0.0001 / 0.0014

### eta_prime_block_0031 (run_id=153)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0043 (run_id=225)
- Partícula: delta_1232, tier: level1, s2_state: latent
...
### quark_ud_const_block_0003 (run_id=253)
...
### tau_block_0019 (run_id=280)
- Partícula: tau, tier: level1, s2_state: none
- match_score.d_total: 1.630
- Bandas: count=6.0, s2_band_fraction=0.0
- band_energies_gev: [1.7931034482758625, 1.8620689655172415, 2.0, 2.0689655172413794, 2.137931034482759, 2.2068965517241383]
- F_m (base): 1.793 GeV
- M_eff (base≈F_m): 1.793
- M_corrected (F_m*(1-H_block)): 1.787 (H_block=0.004)
- sm_mass_gev: 1.777
- Δ_mass vs SM: +0.9142%
- H_block (lock_quality): 0.004
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.8590916035832313, T_ticks=200
- mean_H_lock_norm=0.0035871717925692816, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0020 / 0.0001 / 0.0194

### eta_prime_block_0032 (run_id=229)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### deuteron_block_0033 (run_id=224)
- Partícula: deuteron, tier: level1, s2_state: none
...
### delta_1232_block_0044 (run_id=152)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### eta_prime_block_0033 (run_id=300)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 4.373
- Bandas: count=4.0, s2_band_fraction=0.0
- band_energies_gev: [1.3953488372093024, 1.441860465116279, 2.0, 2.0465116279069764]
- F_m (base): 1.395 GeV
- M_eff (base≈F_m): 1.395
- M_corrected (F_m*(1-H_block)): 1.393 (H_block=0.002)
- sm_mass_gev: 0.958
- Δ_mass vs SM: +45.6857%
- H_block (lock_quality): 0.002
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.7709820116693133, T_ticks=200
- mean_H_lock_norm=0.0018743970136358042, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0008 / 0.0001 / 0.0023

### deuteron_block_0034 (run_id=47)
- Partícula: deuteron, tier: level1, s2_state: none
...
### delta_1232_block_0045 (run_id=29)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0046 (run_id=193)
- Partícula: delta_1232, tier: none, s2_state: structural
- match_score.d_total: 8.107
- Bandas: count=1.0, s2_band_fraction=1.0
...
### delta_1232_block_0047 (run_id=20)
...
### eta_prime_block_0034 (run_id=87)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 0.420
- Bandas: count=5.0, s2_band_fraction=0.0
...
### deuteron_block_0035 (run_id=176)
- Partícula: deuteron, tier: level1, s2_state: none
...
### eta_prime_block_0035 (run_id=123)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### deuteron_block_0036 (run_id=159)
- Partícula: deuteron, tier: level1, s2_state: none
...
### eta_prime_block_0036 (run_id=138)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### deuteron_block_0037 (run_id=171)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 4.107
- Bandas: count=3.0, s2_band_fraction=0.0
...
### delta_1232_block_0048 (run_id=154)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### eta_prime_block_0037 (run_id=100)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### eta_prime_block_0038 (run_id=37)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0049 (run_id=151)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 7.680
- Bandas: count=1.0, s2_band_fraction=0.0
- band_energies_gev: [2.0]
...
### delta_1232_block_0050 (run_id=289)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 4.929
- Bandas: count=2.0, s2_band_fraction=0.0
- band_energies_gev: [1.4736842105263157, 2.0]
- F_m (base): 1.474 GeV
- M_eff (base≈F_m): 1.474
- M_corrected (F_m*(1-H_block)): 1.468 (H_block=0.004)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +19.6172%
- H_block (lock_quality): 0.004
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.7083676789945835, T_ticks=200
- mean_H_lock_norm=0.0035954636766517157, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0014 / 0.0002 / 0.0034

### delta_1232_block_0051 (run_id=302)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 7.739
- Bandas: count=1.0, s2_band_fraction=0.0
- band_energies_gev: [1.9611650485436893, 1.9805825242718444, 1.9999999999999998]
- F_m (base): 1.961 GeV
- M_eff (base≈F_m): 1.961
- M_corrected (F_m*(1-H_block)): 1.929 (H_block=0.016)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +59.1855%
- H_block (lock_quality): 0.016
- band_power_capture: 0.7098709414238865
- chaos_mode=dynamic, PE_tick_norm=0.35968539611351413, T_ticks=200
- mean_H_lock_norm=0.016368876039504727, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0166 / 0.0042 / 0.0355

### delta_1232_block_0052 (run_id=166)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### eta_prime_block_0040 (run_id=252)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 0.056
- Bandas: count=4.0, s2_band_fraction=0.0
...
### delta_1232_block_0053 (run_id=106)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### deuteron_block_0040 (run_id=197)
- Partícula: deuteron, tier: level1, s2_state: none
...
### deuteron_block_0041 (run_id=240)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 4.107
- Bandas: count=2.0, s2_band_fraction=0.0
...
### delta_1232_block_0054 (run_id=307)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 7.769
- Bandas: count=1.0, s2_band_fraction=0.0
- band_energies_gev: [1.9639639639639639, 1.981981981981982, 2.0, 2.0180180180180183]
- F_m (base): 1.964 GeV
- M_eff (base≈F_m): 1.964
- M_corrected (F_m*(1-H_block)): 1.960 (H_block=0.002)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +59.4127%
- H_block (lock_quality): 0.002
- band_power_capture: 0.6735737855382552
- chaos_mode=dynamic, PE_tick_norm=0.5480697989462867, T_ticks=200
- mean_H_lock_norm=0.00215773550014064, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0002 / 0.0000 / 0.0005

### tau_block_0023 (run_id=278)
- Partícula: tau, tier: level1, s2_state: none
- match_score.d_total: 4.953
- Bandas: count=3.0, s2_band_fraction=0.0
- band_energies_gev: [1.7272727272727275, 1.9545454545454548, 2.0]
- F_m (base): 1.727 GeV
- M_eff (base≈F_m): 1.727
- M_corrected (F_m*(1-H_block)): 1.717 (H_block=0.006)
- sm_mass_gev: 1.777
- Δ_mass vs SM: -2.7907%
- H_block (lock_quality): 0.006
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.736231025172402, T_ticks=200
- mean_H_lock_norm=0.005859966880790448, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0007 / 0.0002 / 0.0015

### eta_prime_block_0041 (run_id=66)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0055 (run_id=143)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0056 (run_id=200)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0057 (run_id=247)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### deuteron_block_0042 (run_id=196)
- Partícula: deuteron, tier: level1, s2_state: none
...
### quark_ud_const_block_0004 (run_id=2)
- Partícula: quark_ud_const, tier: none, s2_state: none
...
### delta_1232_block_0058 (run_id=283)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 5.112
- Bandas: count=3.0, s2_band_fraction=0.0
- band_energies_gev: [1.674418604651163, 1.9534883720930234, 2.0]
- F_m (base): 1.674 GeV
- M_eff (base≈F_m): 1.674
- M_corrected (F_m*(1-H_block)): 1.659 (H_block=0.009)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +35.9106%
- H_block (lock_quality): 0.009
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.6169323874519633, T_ticks=200
- mean_H_lock_norm=0.00914121288924021, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0033 / 0.0001 / 0.0102

### delta_1232_block_0059 (run_id=28)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### eta_prime_block_0042 (run_id=274)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 4.252
- Bandas: count=2.0, s2_band_fraction=0.0
- band_energies_gev: [1.3831775700934579, 2.0]
- F_m (base): 1.383 GeV
- M_eff (base≈F_m): 1.383
- M_corrected (F_m*(1-H_block)): 1.376 (H_block=0.005)
- sm_mass_gev: 0.958
- Δ_mass vs SM: +44.4150%
- H_block (lock_quality): 0.005
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.46293430658377155, T_ticks=200
- mean_H_lock_norm=0.005041099282463116, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
...
### delta_1232_block_0060 (run_id=164)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 7.680
- Bandas: count=1.0, s2_band_fraction=0.0
- band_energies_gev: [2.0]
...
### delta_1232_block_0061 (run_id=117)
- Partícula: delta_1232, tier: level1, s2_state: latent
...
### deuteron_block_0043 (run_id=130)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 1.846
- Bandas: count=4.0, s2_band_fraction=0.0
...
### eta_prime_block_0043 (run_id=167)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### deuteron_block_0044 (run_id=168)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 1.531
- Bandas: count=2.0, s2_band_fraction=0.0
...
### eta_prime_block_0044 (run_id=92)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0062 (run_id=219)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### quark_s_const_block_0002 (run_id=42)
- Partícula: quark_s_const, tier: none, s2_state: none
...
### eta_prime_block_0045 (run_id=269)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 0.855
- Bandas: count=5.0, s2_band_fraction=0.0
- band_energies_gev: [1.0434782608695652, 1.9130434782608696, 2.0, 2.0869565217391304, 2.1739130434782608]
- F_m (base): 1.043 GeV
- M_eff (base≈F_m): 1.043
- M_corrected (F_m*(1-H_block)): 1.040 (H_block=0.003)
- sm_mass_gev: 0.958
...
- mean_H_lock_norm=0.003334801260939006, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0036 / 0.0006 / 0.0104

### deuteron_block_0046 (run_id=126)
- Partícula: deuteron, tier: level1, s2_state: none
...
### eta_prime_block_0046 (run_id=162)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0063 (run_id=272)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 7.836
- Bandas: count=2.0, s2_band_fraction=0.0
- band_energies_gev: [1.9701492537313436, 1.9850746268656718, 2.0, 2.014925373134328, 2.029850746268657, 2.1044776119402986, 2.1194029850746268]
- F_m (base): 1.970 GeV
- M_eff (base≈F_m): 1.970
- M_corrected (F_m*(1-H_block)): 1.955 (H_block=0.008)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +59.9147%
- H_block (lock_quality): 0.008
- band_power_capture: 0.6205532755391927
- chaos_mode=dynamic, PE_tick_norm=0.749112519424977, T_ticks=200
- mean_H_lock_norm=0.007269821793114429, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0007 / 0.0001 / 0.0018

### deuteron_block_0047 (run_id=147)
- Partícula: deuteron, tier: level1, s2_state: none
...
### delta_1232_block_0064 (run_id=158)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0065 (run_id=189)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 7.680
- Bandas: count=1.0, s2_band_fraction=0.0
- band_energies_gev: [2.0]
...
### deuteron_block_0049 (run_id=238)
- Partícula: deuteron, tier: level1, s2_state: none
...
### delta_1232_block_0066 (run_id=256)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 3.522
- Bandas: count=3.0, s2_band_fraction=0.0
- band_energies_gev: [1.375, 1.5, 2.0]
- F_m (base): 1.375 GeV
- M_eff (base≈F_m): 1.375
- M_corrected (F_m*(1-H_block)): 1.371 (H_block=0.003)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +11.6071%
- H_block (lock_quality): 0.003
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.6664808233330313, T_ticks=200
- mean_H_lock_norm=0.002762184284984729, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0013 / 0.0001 / 0.0041

### deuteron_block_0050 (run_id=118)
- Partícula: deuteron, tier: level1, s2_state: none
...
### deuteron_block_0051 (run_id=288)
- Partícula: deuteron, tier: level1, s2_state: latent
- match_score.d_total: 5.988
- Bandas: count=6.0, s2_band_fraction=0.0
- band_energies_gev: [1.935483870967742, 1.9677419354838708, 1.9999999999999998, 2.032258064516129, 2.064516129032258, 2.096774193548387]
- F_m (base): 1.935 GeV
- M_eff (base≈F_m): 1.935
- M_corrected (F_m*(1-H_block)): 1.910 (H_block=0.013)
- sm_mass_gev: 1.876
- Δ_mass vs SM: +3.1922%
- H_block (lock_quality): 0.013
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.6192769100326612, T_ticks=200
- mean_H_lock_norm=0.013000892209583214, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0012 / 0.0002 / 0.0025

### delta_1232_block_0067 (run_id=129)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0068 (run_id=62)
- Partícula: delta_1232, tier: level1, s2_state: latent
- match_score.d_total: 7.680
- Bandas: count=1.0, s2_band_fraction=0.0
- band_energies_gev: [2.0]
...
### deuteron_block_0052 (run_id=131)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 1.914
- Bandas: count=4.0, s2_band_fraction=0.0
...
### deuteron_block_0053 (run_id=165)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 3.551
- Bandas: count=3.0, s2_band_fraction=0.0
...
### delta_1232_block_0069 (run_id=214)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### deuteron_block_0054 (run_id=157)
- Partícula: deuteron, tier: level1, s2_state: latent
- match_score.d_total: 1.846
- Bandas: count=7.0, s2_band_fraction=0.0
...
### deuteron_block_0055 (run_id=244)
- Partícula: deuteron, tier: level1, s2_state: none
...
### eta_prime_block_0047 (run_id=199)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 1.753
- Bandas: count=6.0, s2_band_fraction=0.0
...
### delta_1232_block_0070 (run_id=265)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 4.284
- Bandas: count=5.0, s2_band_fraction=0.0
- band_energies_gev: [1.4482758620689653, 1.9310344827586208, 2.0, 2.0689655172413794, 2.1379310344827585]
- F_m (base): 1.448 GeV
- M_eff (base≈F_m): 1.448
- M_corrected (F_m*(1-H_block)): 1.438 (H_block=0.007)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +17.5549%
- H_block (lock_quality): 0.007
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.9161155456811826, T_ticks=200
- mean_H_lock_norm=0.007207230259514577, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.8577 / 0.5831 / 0.9540

### deuteron_block_0057 (run_id=230)
- Partícula: deuteron, tier: level1, s2_state: none
...
### delta_1232_block_0071 (run_id=107)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### deuteron_block_0058 (run_id=203)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 0.060
- Bandas: count=2.0, s2_band_fraction=0.0
...
### delta_1232_block_0072 (run_id=61)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 7.680
- Bandas: count=1.0, s2_band_fraction=0.0
- band_energies_gev: [2.0]
...
### eta_prime_block_0048 (run_id=228)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 1.753
- Bandas: count=3.0, s2_band_fraction=0.0
...
### eta_prime_block_0049 (run_id=111)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 4.266
- Bandas: count=5.0, s2_band_fraction=0.0
...
### delta_1232_block_0073 (run_id=52)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0074 (run_id=19)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 4.188
- Bandas: count=2.0, s2_band_fraction=0.0
...
### quark_ud_const_block_0005 (run_id=98)
- Partícula: quark_ud_const, tier: level2, s2_state: none
...
### delta_1232_block_0075 (run_id=291)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 7.680
- Bandas: count=1.0, s2_band_fraction=0.0
- band_energies_gev: [2.0]
...
- mean_H_lock_norm=0.008825391354704412, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0013 / 0.0005 / 0.0028

### delta_1232_block_0076 (run_id=234)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### deuteron_block_0059 (run_id=212)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 4.597
- Bandas: count=4.0, s2_band_fraction=0.0
...
### delta_1232_block_0077 (run_id=156)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 3.403
- Bandas: count=6.0, s2_band_fraction=0.0
...
### deuteron_block_0060 (run_id=275)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 8.931
- Bandas: count=2.0, s2_band_fraction=0.0
- band_energies_gev: [1.9649122807017547, 1.9999999999999998]
- F_m (base): 1.965 GeV
- M_eff (base≈F_m): 1.965
- M_corrected (F_m*(1-H_block)): 1.938 (H_block=0.014)
- sm_mass_gev: 1.876
- Δ_mass vs SM: +4.7612%
- H_block (lock_quality): 0.014
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.6317131399662129, T_ticks=200
- mean_H_lock_norm=0.013851967559860201, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0169 / 0.0011 / 0.0503

### tau_block_0033 (run_id=277)
- Partícula: tau, tier: level1, s2_state: none
- match_score.d_total: 0.098
- Bandas: count=6.0, s2_band_fraction=0.0
- band_energies_gev: [1.777777777777778, 1.888888888888889, 2.0, 2.111111111111111, 2.2222222222222223, 2.333333333333334]
- F_m (base): 1.778 GeV
- M_eff (base≈F_m): 1.778
- M_corrected (F_m*(1-H_block)): 1.771 (H_block=0.004)
- sm_mass_gev: 1.777
- Δ_mass vs SM: +0.0517%
- H_block (lock_quality): 0.004
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.6747724039376636, T_ticks=200
- mean_H_lock_norm=0.003766851880028642, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0006 / 0.0001 / 0.0011

### quark_ud_const_block_0006 (run_id=268)
- Partícula: quark_ud_const, tier: none, s2_state: latent
- match_score.d_total: 0.691
- Bandas: count=2.0, s2_band_fraction=0.0
- band_energies_gev: [0.2608695652173913, 2.0]
- F_m (base): 0.261 GeV
- M_eff (base≈F_m): 0.261
- M_corrected (F_m*(1-H_block)): 0.094 (H_block=0.639)
- sm_mass_gev: 0.336
- Δ_mass vs SM: -22.3602%
- H_block (lock_quality): 0.639
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.5910765575037181, T_ticks=200
- mean_H_lock_norm=0.009423324536761384, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=1.0
- fraction_structured=0.5
- lock_S1_series (mean/min/max): 0.8634 / 0.5737 / 0.9784

### tau_block_0034 (run_id=287)
- Partícula: tau, tier: level1, s2_state: none
- match_score.d_total: 3.272
- Bandas: count=3.0, s2_band_fraction=0.0
- band_energies_gev: [1.8095238095238095, 1.9047619047619047, 2.0]
- F_m (base): 1.810 GeV
- M_eff (base≈F_m): 1.810
- M_corrected (F_m*(1-H_block)): 1.805 (H_block=0.002)
- sm_mass_gev: 1.777
- Δ_mass vs SM: +1.8383%
- H_block (lock_quality): 0.002
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.7296846762405677, T_ticks=200
- mean_H_lock_norm=0.002361512092074849, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0016 / 0.0003 / 0.0064

### tau_block_0035 (run_id=160)
- Partícula: tau, tier: level1, s2_state: none
- match_score.d_total: 0.098
- Bandas: count=6.0, s2_band_fraction=0.0
...
### eta_prime_block_0050 (run_id=24)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 0.420
- Bandas: count=3.0, s2_band_fraction=0.0
...
### delta_1232_block_0078 (run_id=56)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### eta_prime_block_0051 (run_id=195)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 3.753
- Bandas: count=3.0, s2_band_fraction=0.0
...
### quark_ud_const_block_0007 (run_id=294)
- Partícula: quark_ud_const, tier: level2, s2_state: none
- match_score.d_total: 0.629
- Bandas: count=2.0, s2_band_fraction=0.0
- band_energies_gev: [0.3928571428571428, 0.4047619047619047, 1.9999999999999998]
- F_m (base): 0.393 GeV
- M_eff (base≈F_m): 0.393
- M_corrected (F_m*(1-H_block)): 0.164 (H_block=0.582)
- sm_mass_gev: 0.336
- Δ_mass vs SM: +16.9218%
- H_block (lock_quality): 0.582
- band_power_capture: 0.9527574206108375
- chaos_mode=dynamic, PE_tick_norm=0.5644607244973389, T_ticks=200
- mean_H_lock_norm=0.004458970458148581, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.9182958340544894
- fraction_structured=0.3333333333333333
- lock_S1_series (mean/min/max): 0.5714 / 0.1087 / 0.9228

### deuteron_block_0061 (run_id=266)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 2.440
- Bandas: count=5.0, s2_band_fraction=0.0
- band_energies_gev: [1.9, 1.9499999999999997, 2.0, 2.05, 2.0999999999999996]
- F_m (base): 1.900 GeV
- M_eff (base≈F_m): 1.900
- M_corrected (F_m*(1-H_block)): 1.895 (H_block=0.002)
- sm_mass_gev: 1.876
- Δ_mass vs SM: +1.3004%
- H_block (lock_quality): 0.002
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.5717658790253036, T_ticks=200
- mean_H_lock_norm=0.0024517363874947077, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0011 / 0.0001 / 0.0024

### delta_1232_block_0079 (run_id=39)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### eta_prime_block_0052 (run_id=155)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### quark_ud_const_block_0008 (run_id=213)
- Partícula: quark_ud_const, tier: level2, s2_state: none
...
### delta_1232_block_0080 (run_id=142)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 4.957
- Bandas: count=2.0, s2_band_fraction=0.0
...
### eta_prime_block_0053 (run_id=79)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 4.266
- Bandas: count=3.0, s2_band_fraction=0.0
...
### delta_1232_block_0081 (run_id=69)
- Partícula: delta_1232, tier: level1, s2_state: latent
...
### delta_1232_block_0082 (run_id=235)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### deuteron_block_0063 (run_id=178)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 4.227
- Bandas: count=7.0, s2_band_fraction=0.0
...
### eta_prime_block_0054 (run_id=270)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 3.611
- Bandas: count=4.0, s2_band_fraction=0.0
- band_energies_gev: [1.319148936170213, 1.9574468085106385, 2.0, 2.0425531914893615]
- F_m (base): 1.319 GeV
- M_eff (base≈F_m): 1.319
- M_corrected (F_m*(1-H_block)): 1.313 (H_block=0.004)
- sm_mass_gev: 0.958
- Δ_mass vs SM: +37.7298%
- H_block (lock_quality): 0.004
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.6279330110169322, T_ticks=200
- mean_H_lock_norm=0.0043642750202154725, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0139 / 0.0012 / 0.0907

### delta_1232_block_0083 (run_id=88)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### deuteron_block_0064 (run_id=201)
- Partícula: deuteron, tier: level1, s2_state: none
...
### delta_1232_block_0084 (run_id=267)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 4.398
- Bandas: count=3.0, s2_band_fraction=0.0
- band_energies_gev: [1.692307692307692, 1.7435897435897432, 2.0]
- F_m (base): 1.692 GeV
- M_eff (base≈F_m): 1.692
- M_corrected (F_m*(1-H_block)): 1.688 (H_block=0.003)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +37.3626%
- H_block (lock_quality): 0.003
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.7646141039352251, T_ticks=200
- mean_H_lock_norm=0.002526066043362606, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
...
### deuteron_block_0066 (run_id=148)
- Partícula: deuteron, tier: level1, s2_state: none
...
### deuteron_block_0067 (run_id=227)
- Partícula: deuteron, tier: level1, s2_state: none
...
### eta_prime_block_0057 (run_id=170)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0085 (run_id=220)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 4.136
- Bandas: count=4.0, s2_band_fraction=0.0
...
### deuteron_block_0068 (run_id=149)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 1.846
- Bandas: count=4.0, s2_band_fraction=0.0
- band_energies_gev: [1.8571428571428574, 1.9285714285714286, 2.0, 2.0714285714285716]
...
### delta_1232_block_0086 (run_id=145)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### eta_prime_block_0058 (run_id=215)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### eta_prime_block_0059 (run_id=51)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### deuteron_block_0069 (run_id=185)
- Partícula: deuteron, tier: level1, s2_state: none
...
### delta_1232_block_0087 (run_id=210)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0088 (run_id=9)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 2.560
- Bandas: count=5.0, s2_band_fraction=0.0
...
### delta_1232_block_0089 (run_id=273)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 3.993
- Bandas: count=5.0, s2_band_fraction=0.0
- band_energies_gev: [1.5094339622641508, 1.5471698113207546, 2.0, 2.0377358490566038, 2.0754716981132075]
- F_m (base): 1.509 GeV
- M_eff (base≈F_m): 1.509
- M_corrected (F_m*(1-H_block)): 1.508 (H_block=0.001)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +22.5190%
- H_block (lock_quality): 0.001
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.7452221411961598, T_ticks=200
- mean_H_lock_norm=0.0009102926420372192, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0024 / 0.0001 / 0.0087

### deuteron_block_0070 (run_id=112)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 1.329
- Bandas: count=5.0, s2_band_fraction=0.0
...
### delta_1232_block_0090 (run_id=38)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### eta_prime_block_0061 (run_id=94)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 0.976
- Bandas: count=2.0, s2_band_fraction=0.0
...
### eta_prime_block_0062 (run_id=16)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### deuteron_block_0071 (run_id=184)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 3.551
- Bandas: count=5.0, s2_band_fraction=0.0
...
### delta_1232_block_0091 (run_id=243)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### eta_prime_block_0063 (run_id=105)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### deuteron_block_0072 (run_id=276)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 6.190
- Bandas: count=2.0, s2_band_fraction=0.0
- band_energies_gev: [1.9375, 2.0]
- F_m (base): 1.938 GeV
- M_eff (base≈F_m): 1.938
- M_corrected (F_m*(1-H_block)): 1.923 (H_block=0.007)
- sm_mass_gev: 1.876
- Δ_mass vs SM: +3.2997%
- H_block (lock_quality): 0.007
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.7474219666823597, T_ticks=200
- mean_H_lock_norm=0.007311580264259055, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0509 / 0.0001 / 0.5667

### eta_prime_block_0064 (run_id=161)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0092 (run_id=231)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0093 (run_id=177)
- Partícula: delta_1232, tier: level1, s2_state: latent
...
### delta_1232_block_0094 (run_id=262)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 4.536
- Bandas: count=5.0, s2_band_fraction=0.0
- band_energies_gev: [1.6097560975609755, 1.9512195121951217, 1.9999999999999998, 2.048780487804878, 2.097560975609756]
- F_m (base): 1.610 GeV
- M_eff (base≈F_m): 1.610
- M_corrected (F_m*(1-H_block)): 1.605 (H_block=0.003)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +30.6620%
- H_block (lock_quality): 0.003
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.7357371410295896, T_ticks=200
- mean_H_lock_norm=0.003041516246956631, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0022 / 0.0002 / 0.0181

### quark_ud_const_block_0009 (run_id=59)
...
### delta_1232_block_0095 (run_id=91)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0096 (run_id=174)
- Partícula: delta_1232, tier: level1, s2_state: latent
- match_score.d_total: 9.399
- Bandas: count=1.0, s2_band_fraction=0.0
...
### delta_1232_block_0097 (run_id=27)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### deuteron_block_0076 (run_id=141)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 6.190
- Bandas: count=3.0, s2_band_fraction=0.0
...
### deuteron_block_0077 (run_id=237)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 0.463
- Bandas: count=7.0, s2_band_fraction=0.0
...
### delta_1232_block_0098 (run_id=77)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### eta_prime_block_0065 (run_id=10)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0099 (run_id=306)
- Partícula: delta_1232, tier: none, s2_state: structural
- match_score.d_total: 8.104
- Bandas: count=1.0, s2_band_fraction=1.0
- band_energies_gev: [1.9948453608247423, 1.9974226804123711, 2.0, 2.002577319587629, 2.0051546391752577, 2.0077319587628866, 2.0103092783505154, 2.0128865979381443, 2.015463917525773, 2.018041237113402, 2.020618556701031, 2.0231958762886597, 2.025773195876288, 2.0283505154639174, 2.0309278350515463, 2.033505154639175, 2.0360824742268044, 2.0386597938144333, 2.041237113402062, 2.0438144329896906, 2.04639175257732, 2.0489690721649483, 2.0515463917525776, 2.0541237113402064, 2.0567010309278353, 2.059278350515464, 2.0618556701030926, 2.064432989690722, 2.0670103092783503, 2.0695876288659796]
- F_m (base): 1.995 GeV
- M_eff (base≈F_m): 1.995
- M_corrected (F_m*(1-H_block)): 1.995 (H_block=0.000)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +61.9193%
- H_block (lock_quality): 0.000
- band_power_capture: 0.04332162603519586
- chaos_mode=dynamic, PE_tick_norm=0.7659009579977081, T_ticks=200
- mean_H_lock_norm=1.0266195682330714e-05, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=1.0
- lock_S1_series (mean/min/max): 0.0005 / 0.0000 / 0.0018

### deuteron_block_0079 (run_id=301)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 2.684
- Bandas: count=4.0, s2_band_fraction=0.0
- band_energies_gev: [1.9024390243902443, 1.9512195121951221, 2.0, 2.0487804878048785]
- F_m (base): 1.902 GeV
- M_eff (base≈F_m): 1.902
- M_corrected (F_m*(1-H_block)): 1.897 (H_block=0.003)
- sm_mass_gev: 1.876
- Δ_mass vs SM: +1.4304%
- H_block (lock_quality): 0.003
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.6846858894871077, T_ticks=200
- mean_H_lock_norm=0.0026910154640084546, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0002 / 0.0000 / 0.0005

### deuteron_block_0080 (run_id=250)
- Partícula: deuteron, tier: level1, s2_state: none
...
### eta_prime_block_0066 (run_id=281)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 1.253
- Bandas: count=3.0, s2_band_fraction=0.0
- band_energies_gev: [1.0833333333333333, 1.916666666666667, 2.0]
- F_m (base): 1.083 GeV
- M_eff (base≈F_m): 1.083
- M_corrected (F_m*(1-H_block)): 1.081 (H_block=0.002)
- sm_mass_gev: 0.958
- Δ_mass vs SM: +13.1088%
- H_block (lock_quality): 0.002
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.6757829830888562, T_ticks=200
- mean_H_lock_norm=0.001911259574079776, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.2599 / 0.0077 / 0.8696

### delta_1232_block_0100 (run_id=72)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### deuteron_block_0081 (run_id=255)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 1.353
- Bandas: count=4.0, s2_band_fraction=0.0
...
### deuteron_block_0082 (run_id=101)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 4.440
- Bandas: count=5.0, s2_band_fraction=0.0
...
### delta_1232_block_0101 (run_id=191)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0102 (run_id=3)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 7.680
- Bandas: count=1.0, s2_band_fraction=0.0
- band_energies_gev: [2.0]
...
### deuteron_block_0083 (run_id=246)
- Partícula: deuteron, tier: level1, s2_state: none
...
### deuteron_block_0084 (run_id=284)
- Partícula: deuteron, tier: level1, s2_state: none
- match_score.d_total: 0.893
- Bandas: count=4.0, s2_band_fraction=0.0
- band_energies_gev: [1.866666666666667, 1.9333333333333336, 2.0, 2.066666666666667]
- F_m (base): 1.867 GeV
- M_eff (base≈F_m): 1.867
- M_corrected (F_m*(1-H_block)): 1.862 (H_block=0.002)
- sm_mass_gev: 1.876
- Δ_mass vs SM: -0.4768%
- H_block (lock_quality): 0.002
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.6835192818501548, T_ticks=200
- mean_H_lock_norm=0.002308004262943662, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0004 / 0.0001 / 0.0008

### eta_prime_block_0067 (run_id=55)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0103 (run_id=116)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### eta_prime_block_0068 (run_id=146)
- Partícula: eta_prime, tier: level1, s2_state: latent
- match_score.d_total: 0.349
- Bandas: count=3.0, s2_band_fraction=0.0
...
### delta_1232_block_0104 (run_id=282)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 3.703
- Bandas: count=4.0, s2_band_fraction=0.0
- band_energies_gev: [1.4615384615384617, 1.5384615384615385, 2.0, 2.0769230769230766]
- F_m (base): 1.462 GeV
- M_eff (base≈F_m): 1.462
- M_corrected (F_m*(1-H_block)): 1.455 (H_block=0.005)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +18.6314%
- H_block (lock_quality): 0.005
- band_power_capture: 1.0
- chaos_mode=dynamic, PE_tick_norm=0.8264098093998462, T_ticks=200
- mean_H_lock_norm=0.004598741104518748, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=0.0
- lock_S1_series (mean/min/max): 0.0049 / 0.0002 / 0.0529

### delta_1232_block_0105 (run_id=292)
- Partícula: delta_1232, tier: none, s2_state: none
- match_score.d_total: 9.573
- Bandas: count=1.0, s2_band_fraction=0.0
- band_energies_gev: [1.9831932773109244, 2.0]
- F_m (base): 1.983 GeV
- M_eff (base≈F_m): 1.983
- M_corrected (F_m*(1-H_block)): 1.969 (H_block=0.007)
- sm_mass_gev: 1.232
- Δ_mass vs SM: +60.9735%
- H_block (lock_quality): 0.007
- band_power_capture: 0.9279573950654965
- chaos_mode=dynamic, PE_tick_norm=0.8529438543719537, T_ticks=200
- mean_H_lock_norm=0.007390386865207347, mixture_entropy_blocks_norm=-0.0, structure_mix_norm=0.0
- fraction_structured=1.0
- lock_S1_series (mean/min/max): 0.9911 / 0.9725 / 0.9969

### deuteron_block_0085 (run_id=103)
- Partícula: deuteron, tier: level1, s2_state: latent
- match_score.d_total: 4.107
- Bandas: count=4.0, s2_band_fraction=0.0
...
### eta_prime_block_0069 (run_id=217)
- Partícula: eta_prime, tier: level1, s2_state: none
- match_score.d_total: 2.420
- Bandas: count=4.0, s2_band_fraction=0.0
