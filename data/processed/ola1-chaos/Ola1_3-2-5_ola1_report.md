...
### delta_1232_block_0001 (run_id=38)
...
### delta_1232_block_0003 (run_id=3)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0004 (run_id=28)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0005 (run_id=52)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0006 (run_id=9)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0007 (run_id=29)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0008 (run_id=20)
...
### eta_prime_block_0005 (run_id=33)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### eta_prime_block_0006 (run_id=32)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0009 (run_id=58)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0010 (run_id=12)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0011 (run_id=39)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### eta_prime_block_0007 (run_id=14)
...
### eta_prime_block_0008 (run_id=10)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0015 (run_id=27)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### eta_prime_block_0009 (run_id=37)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0017 (run_id=35)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### eta_prime_block_0012 (run_id=24)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0018 (run_id=46)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### delta_1232_block_0019 (run_id=43)
- Partícula: delta_1232, tier: level1, s2_state: none
...
### eta_prime_block_0013 (run_id=51)
- Partícula: eta_prime, tier: level1, s2_state: none
...
### delta_1232_block_0020 (run_id=45)
- Partícula: delta_1232, tier: level1, s2_state: none
- match_score.d_total: 2.560
- Bandas: count=3.0, s2_band_fraction=0.0
...
## Semáforo de salud
- Runs totales: 60
- Runs aceptados: 59 (98.3%)
- Alertas: ninguna

## Entropía / Caos (nuevo)
- Fuente de datos: partial_runs
- Runs con entropy_chaos: 59
- chaos_mode: dynamic=59, ensemble=0
- PE_tick_norm (mean/med/min/max): 0.708 / 0.697 / 0.508 / 0.885
...
- structure_mix_norm (mean/med): 0.049 / 0.000
- fraction_structured (mean/med): 0.040 / 0.000

## Inventario (cosecha)
| Partícula | Cantidad | Mejor d_total | Promedio d_total |
|-----------|----------|---------------|------------------|
| delta_1232 | 20 | 2.560 | 5.023 |
| deuteron | 14 | 1.846 | 4.306 |
| eta_prime | 13 | 0.020 | 2.433 |
...
|-----------|-------|-------|-------|-------|-------|-----------|
| delta_1232 | 20 | 2.560 | 4.434 | 9.399 | level1:19, none:1 | none:20 |
| deuteron | 14 | 1.846 | 3.652 | 7.895 | level1:14 | latent:2, none:12 |
| eta_prime | 13 | 0.020 | 2.814 | 4.309 | level1:13 | latent:1, none:12 |
| quark_s_const | 1 | 0.434 | 0.434 | 0.434 | none:1 | none:1 |
| quark_ud_const | 2 | 0.321 | 0.412 | 0.503 | level2:1, none:1 | latent:1, none:1 |
| tau | 9 | 0.465 | 3.570 | 4.347 | level1:9 | none:9 |
