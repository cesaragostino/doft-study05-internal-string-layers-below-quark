...
def main() -> None:
    ...
    parser.add_argument("--data-dir", default="data/processed/paper/data")
    parser.add_argument("--figures-dir", default="data/processed/paper/figures")
    ...
    fig_cmd = [
        ...
        "--genome-ola2",
        str(Path(args.processed_root) / "ola2_paper" / "catalog" / "genome_layers_ola2_paper.csv"),
        "--genome-ola3",
        str(Path(args.processed_root) / "ola3_paper" / "catalog" / "genome_layers_ola3_paper.csv"),
        "--genome-ola4",
        str(Path(args.processed_root) / "ola4_paper" / "catalog" / "genome_layers_ola4_paper.csv"),
        "--out-dir",
        args.figures_dir,
    ]
    _run(fig_cmd)
